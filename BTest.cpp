...
void BTest::test_natural_constructor()
{
    Natural a(-193872);
    bool same = false;
    if ((a.dig[0] == 1)&&(a.dig[1] == 9)&&(a.dig[2] == 3)&&(a.dig[3] == 8)&&(a.dig[4] == 7)&&(a.dig[5] == 2))
        same = true;
    DO_CHECK(same);
}

void BTest::test_integer_constructor()
{
    Integ a("193872");
    bool same = false;
    if ((a.dig[0] == 1)&&(a.dig[1] == 9)&&(a.dig[2] == 3)&&(a.dig[3] == 8)&&(a.dig[4] == 7)&&(a.dig[5] == 2))
    ...
    Integ b(-19387);
    same = false;
    if ((b.dig[0] == 1)&&(b.dig[1] == 9)&&(b.dig[2] == 3)&&(b.dig[3] == 8)&&(b.dig[4] == 7)&&(b.b))
        same = true;
    DO_CHECK(same);
}
