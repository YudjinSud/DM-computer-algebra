#ifndef INTEGBACKENDWRAPPER_H
#define INTEGBACKENDWRAPPER_H
...
class IntegBackendWrapper : public QObject
{
...
public:
    ...
    explicit IntegBackendWrapper(QObject *parent = nullptr);
